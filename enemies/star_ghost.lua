star_ghost_DeathSound = custom_sound("REALMdotEXE/enemies/star_ghost_kill.ogg")

star_ghost_Sprite = custom_sprite("REALMdotEXE/enemies/star_ghost_asleep.png", 4, 9, 9, 40)
star_ghost_ActiveSprite = custom_sprite("REALMdotEXE/enemies/star_ghost.png", 4, 9, 9, 60)

star_ghost = enemy_data("realm_ghost")
